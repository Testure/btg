...
public class ItemToolWireCutters extends ItemTool implements IItemToolMaterial {
	protected final int materialID;
	protected final String[] tooltips;

	public ItemToolWireCutters(String name, int id, int materialID) {
