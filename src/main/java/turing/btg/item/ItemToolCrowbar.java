...
public class ItemToolCrowbar extends ItemTool implements IItemToolMaterial {
	protected final int materialID;
	protected final String[] tooltips;

	public ItemToolCrowbar(String name, int id, int materialID) {
