...
public class ItemToolSaw extends ItemTool implements IItemToolMaterial {
	protected final int materialID;
	protected final String[] tooltips;

	public ItemToolSaw(String name, int id, int materialID) {
		super(name, id, 0, ToolMaterial.wood, BlockTags.MINEABLE_BY_AXE);
