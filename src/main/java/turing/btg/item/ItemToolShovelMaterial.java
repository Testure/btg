...
public class ItemToolShovelMaterial extends ItemToolShovel implements IItemToolMaterial {
	private final int materialID;
	private final String[] tooltips;

	public ItemToolShovelMaterial(String name, int id, int materialID) {
