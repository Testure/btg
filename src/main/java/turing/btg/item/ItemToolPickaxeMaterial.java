...
public class ItemToolPickaxeMaterial extends ItemToolPickaxe implements IItemToolMaterial {
	private final int materialID;
	private final String[] tooltips;

	public ItemToolPickaxeMaterial(String name, int id, int materialID) {
	...
	public boolean canHarvestBlock(Block block) {
		...
		if (miningLevel != null) {
			return getStats().getToolMaterial().getMiningLevel() >= miningLevel;
		} else {
